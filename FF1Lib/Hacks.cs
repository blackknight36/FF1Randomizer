...
namespace FF1Lib
{
	public partial class FF1Rom : NesRom
	{
		...
		public void EnableBuyTen()
		{
            ...
            /* This line draws the menu text 8180 = '10', 8280 = '20' */
			...
			Put(0x3A32C, Blob.FromHex("71A471A4"));
             ...
             /* Buy the items.  To change the number bought change A909 to A9XX on the line below. For example: A913 == Buy 20 */
             /* C9F5 = 245 max.  To avoid overflowing the inventory to 0 we limit the number of items to 245. */
            Put(0x3A45A, Blob.FromHex(""));
            ...
            /* C9F5 = 245 item limit for the "buy" function */
            /* NB: The offset is 10 bytes *behind* where the data ends up in the final ROM */
            Put(0x3A4B3, Blob.FromHex("C9F5"));
			Put(0x3AACB, Blob.FromHex("18A202B5106A95109D0D03CA10F5"));
            /* Update treasure chest limit check */
            Put(0x3DD8C, Blob.FromHex("C9F5"));
		}
